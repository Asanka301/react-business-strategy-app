      ...
      <section id="about">
        <div class="container">
          <div className="title_headling">
            <h3>
              Empowering Entrepreneurs: Strategies for Sustainable Success!
            </h3>
            <p>
          ...
          <div className="about_box_details">
            <div className="about_col">
              ...
              <div className="img_info__box">
                ...
                <a href="/">
                  {faPhoneIcon} <span>075-654-3210</span>
                </a>
              </div>
            </div>
            <div className="about_col more_space">
              <h3>Discovering New Horizons: Unleash Your Business Potential</h3>
              <p>
